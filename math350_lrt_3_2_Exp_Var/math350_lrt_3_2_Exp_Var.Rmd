...
Return to the retirement portfolio question. Calculate the variance and standard deviation using both formulas and simulation
...
grade_result(pass_if(~identical(.result, sd.chg)))
```

* Estimated standard deviation via simulation
