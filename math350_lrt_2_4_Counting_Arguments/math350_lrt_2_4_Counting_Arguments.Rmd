...
:::{#ex1b-hint}
Thee tutorials are case sensitive and order matters. Use "F" to represent female, "M" for male,"A" and "B" for the drugs, and "P" for the placebo.
:::
...
:::{#ex5-hint}
Hint: Calculate the complement and subtract from one.
:::
